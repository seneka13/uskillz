...
const AddHardSkills = () => {
  ...
  const changeFieldValue = useCallback(
    (formField, value) => dispatch(changeField("addExperiences", formField, value)),
    [dispatch]
  );
  ...
  const {
    ...
    hardSkills: state.fieldsReducers.addExperiences.hardSkills,
    selectedHardSkills: state.fieldsReducers.addExperiences.selectedHardSkills,
    selectNeedHardSkill: state.fieldsReducers.addExperiences.selectNeedHardSkill,
  ...
  useEffect(() => {
    ...
    changeFieldValue("selectNeedHardSkill", []);
