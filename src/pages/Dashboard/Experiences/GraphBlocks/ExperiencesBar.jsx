...
const ExpereiencesBar = ({ activeSkills }) => {
  ...
  return (
    <div className={styles.graphBlock} style={{ height: "700px" }}>
      <h3>Experiences</h3>
      <ResponsiveBar
        data={graphsExpAndIndustriesList.experiences}
        keys={graphsExpAndIndustriesList.teams_name || graphsExpAndIndustriesList.users_in_team || ["count"]}
        indexBy="type"
...
export default ExpereiencesBar;
